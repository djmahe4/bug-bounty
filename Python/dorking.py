...
queries = [f'site:{domain} inurl:register.php',f'site:{domain} inurl:portal.php',f'site:{domain} intxt:login',
           ...
           f"site:{domain} ext:log | ext:txt | ext:conf | ext:cnf | ext:ini | ext:env | ext:sh | ext:bak | ext:backup | ext:swp | ext:old | ext:~ | ext:git | ext:svn | ext:htpasswd | ext:htaccess | ext:json", # Configs
